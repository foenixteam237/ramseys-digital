            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
              <div className="reveal mb-16 flex flex-wrap items-end justify-between gap-4">
                <div className="max-w-2xl">
                  <p className="mb-4 font-mono text-xs uppercase tracking-[0.25em] text-rd-red">Nos vidéos</p>
                  <h2 className="font-display text-3xl font-semibold leading-tight sm:text-4xl">
                    Astuces et retours d&apos;expérience en vidéo
                  </h2>
                </div>
                <a
                  ...
                  className="rounded-lg border border-white/20 px-5 py-2.5 text-sm font-semibold transition-colors hover:border-rd-red/50"
                >
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {videos.map((video) => (
                  <div
                    key={video.id}
                    className="reveal card-hover overflow-hidden rounded-2xl border border-rd-line bg-rd-graphite"
                  >
                      ...
                      {playingVideoId === video.id ? (
                        ...
                        >
                          ...
                          <span className="absolute inset-0 flex items-center justify-center bg-black/30 transition-colors group-hover:bg-black/40">
                            <span className="flex h-14 w-14 items-center justify-center rounded-full bg-rd-red/90 shadow-lg shadow-black/40">
                    ...
                    <div className="p-5">
                      <h3 className="line-clamp-2 font-display text-base font-semibold text-white">{video.title}</h3>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2 lg:px-10">
            <div className="reveal">
              ...
              <div className="mt-10 flex items-center gap-4">
                ...
                <a href="https://www.tiktok.com/@ramseys_digital?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex h-10 w-10 items-center justify-center rounded-lg border border-rd-line bg-rd-graphite transition-colors hover:border-rd-red/60 hover:text-rd-red">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M16.5 3c.3 2 1.7 3.6 3.7 3.9v3a7 7 0 0 1-3.7-1.1v6.8a5.8 5.8 0 1 1-5-5.7v3.1a2.7 2.7 0 1 0 1.9 2.6V3h3.1Z" /></svg>
                </a>
              </div>
            </div>
